...
const text = "Hi, I'm Dagim";
let index = 0;

function typeWriter() {
    if (index < text.length) {
        if (text.charAt(index) === 'A' && text.substring(index, index + 4) === 'Dagim') {
            heroTitle.innerHTML = text.substring(0, index) + '<span class="highlight">' + text.substring(index, index + 4) + '</span>';
            index += 4;
        } else {
